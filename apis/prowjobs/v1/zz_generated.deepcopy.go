...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RerunAuthConfigs) DeepCopyInto(out *RerunAuthConfigs) {
	{
		in := &in
		*out = make(RerunAuthConfigs, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RerunAuthConfigs.
func (in RerunAuthConfigs) DeepCopy() RerunAuthConfigs {
	if in == nil {
		return nil
	}
	out := new(RerunAuthConfigs)
	in.DeepCopyInto(out)
	return *out
}
